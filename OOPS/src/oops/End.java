   ...
   public End() {
      	...
      	gl_panel.createParallelGroup(Alignment.LEADING)
      		.addGroup(gl_panel.createSequentialGroup()
      			.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
      				.addGroup(gl_panel.createSequentialGroup()
      					.addGap(227)
      					.addComponent(lblOopsTheEnd, GroupLayout.PREFERRED_SIZE, 772, GroupLayout.PREFERRED_SIZE))
      				.addGroup(gl_panel.createSequentialGroup()
      					.addGap(542)
      					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
      						.addComponent(userId)
      ...
      gl_contentPane.setHorizontalGroup(
      	gl_contentPane.createParallelGroup(Alignment.LEADING)
      		.addComponent(panel, GroupLayout.DEFAULT_SIZE, 1272, Short.MAX_VALUE)
      );
      gl_contentPane.setVerticalGroup(
      	gl_contentPane.createParallelGroup(Alignment.LEADING)
      		.addComponent(panel, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 843, Short.MAX_VALUE)
      );
